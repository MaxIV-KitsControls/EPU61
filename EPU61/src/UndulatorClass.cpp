...
void UndulatorClass::set_default_property()
{
	...
	prop_name = "DataFile";
	prop_desc = "File containing correction coil interpolation table";
	prop_def  = "";
	vect_data.clear();
	if (prop_def.length()>0)
	{
...
void UndulatorClass::attribute_factory(vector<Tango::Attr *> &att_list)
{
	...
	//	description	not set for	Coil1
	//	label	not set for	Coil1
	//	unit	not set for	Coil1
	...
	//	description	not set for	Coil2
	//	label	not set for	Coil2
	//	unit	not set for	Coil2
	...
	//	description	not set for	Coil3
	//	label	not set for	Coil3
	//	unit	not set for	Coil3
	...
	//	description	not set for	Coil4
	//	label	not set for	Coil4
	//	unit	not set for	Coil4
	...
	//	description	not set for	CorrectionEnabled
