...
{
  //- TraceHelper t("DynamicAttributeManager::DynamicAttributeManager", this);
}
	...
	throw (Tango::DevFailed)
{
  ...
  this->dev_ = h;
  //- this->set_logger(h ? h->get_logger() : 0);
}
...
void DynamicAttributeManager::add_attributes (const std::vector<DynamicAttributeInfo>& ai)
	throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::add_attributes", this);
...
void DynamicAttributeManager::add_attribute (const yat4tango::DynamicAttributeInfo& dai)
	throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::add_attribute[const yat4tango::DynamicAttributeInfo&]", this);
...
void DynamicAttributeManager::add_attribute (yat4tango::DynamicAttribute * da)
	throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::add_attribute[DynamicAttribute*]", this);
...
void DynamicAttributeManager::add_attribute (const std::string& url, const std::string& lan, bool rdo)
  throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::add_attribute", this);
...
void DynamicAttributeManager::add_attribute (const yat4tango::ForwardedAttributeInfo& dai)
  throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::add_attribute[yat4tango::ForwardedAttributeInfo&]", this);
...
void DynamicAttributeManager::remove_attribute (const std::string& an)
	throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::remove_attribute", this);
...
void DynamicAttributeManager::remove_attributes()
	throw (Tango::DevFailed)
{
  //- TraceHelper t("DynamicAttributeManager::remove_attributes", this);
