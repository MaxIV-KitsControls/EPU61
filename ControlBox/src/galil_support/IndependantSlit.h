...
#ifndef _INDEPENDANT_SLIT_H_
#define _INDEPENDANT_SLIT_H_
...
//- CLASS: Slit
//------------------------------------------------------------------------------
class IndependantSlit : public AbstractSlit
{
public:
  //- ctor
  IndependantSlit ();
...
private:
  ...
  //-----------------------------------
  IndependantSlit (const IndependantSlit &);
  IndependantSlit & operator= (const IndependantSlit &);

protected: 
	//---------------------------------------------------------
  // IndependantSlit::command_allowed
  //---------------------------------------------------------
  // Given the current status of the IndependantSlit, this 
